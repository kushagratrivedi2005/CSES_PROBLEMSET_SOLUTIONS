...
void solve(int xyz)
{
  ...
  int x1new=x2-x1;int x2new=x3-x1;int y2new=y3-y1;int y1new=y2-y1;
  int area=(x1new*y2new)-(x2new*y1new);
  if(area==0){cout<<"TOUCH"<<endl;return;}
  if(area>0){cout<<"LEFT"<<endl;return;}
